...
\begin{frame}{Which has `Better' Contrast?}
    \only<1>{
    \begin{figure}
        \subfigure[Image 1]{\includegraphics[width=2.5in]{../data/image-1.jpg}}
        \subfigure[Image 2]{\includegraphics[width=2.5in]{../data/image-2.jpg}}
        % \caption{Flat histogram gives better contrast.}
    \end{figure}
    }
    % \only<2>{
    % \begin{figure}
    %     \subfigure[Histogram of Image 1]{\includegraphics[width=2.3in]{../data/hist-image-1.png}}
    %     \subfigure[Histogram of Image 2]{\includegraphics[width=2.3in]{../data/hist-image-2.png}}
